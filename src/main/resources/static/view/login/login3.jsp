...
<link type="text/css" rel="stylesheet"
	href="/images/page3/0408f819.css">
</head>
<body>
	<div style="height: 780px;" class="container">
		...
		<div class="top">
			<img style="left: -120.5px; top: 0px; width: auto; height: 100%;"
				class="top_bg" src="/images/page3/top_bg_compress.png">
		...
		<div style="display: block;" class="computer">
			<img style="left: 231.5px; top: 120px;" class="computer_bg"
				src="/images/page3/computer_bg.png">
			<div class="no-css3">
		...
		<div style="display: block;" class="synchronous">
			<img style="left: 231.5px; top: 120px;" class="synchronous_bg"
				src="/images/page3/synchronous_bg.png">
			<div class="no-css3">
		...
		<div style="display: block;" class="explore">
			<img style="left: 231.5px; top: 120px;" class="explore_bg"
				src="/images/page3/explore_bg.png">
			<div class="no-css3">
		...
		<div style="display: block;" class="end">
			<div style="height: 558px;" class="download">
				<img style="top: 143.5px;" class="download_bg"
					src="/images/page3/download_bg.png"> <a
			...
			<div id="footer">
				<ul id="ft-follow-us">
					<li><a id="weibo"
						target="_blank"></a></li>
					<li><a id="wechat"><img
							src="/images/page3/e5ea2639.png"></a></li>
					<li><a id="qq"><img
							src="/images/page3/d984692a.png"></a></li>
				</ul>
				<ul id="ft-links">
					<li><a
	...
	<script src="/images/page3/rlog.js" async=""
		type="text/javascript"></script>
	<script style="color: rgb(0, 0, 0);"
		src="/images/page3/1875d44e.js"></script>
	<script src="/images/page3/b58ec580.js"></script>
</body>
<script>
