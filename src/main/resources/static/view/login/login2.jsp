...
function refreshMe(obj) {
	obj.src = "/ttsweb/verifyCode/getCode.do?t=" + Math.random();
}
</script>
    </head>
    <body class="">
    <div class="hd">
        <div class="wrap">
            <div class="hd-main">
            <h1 class="logo"><img src="/images/663ffc1b.png" alt="云笔记"></h1>
            <div class="nav">
    ...
    <div class="bd">
        ...
        <div class="bd-login-main">
            ...
            <form class="login-left"  action="/login/loginnow" method="post" id ="login_form">
                <h2>账号登录：</h2>
        ...
        <div class="bd-feture">
            <div class="bd-feture-main">
                <img src="/images/a88d3aa3.png" alt="随时记录 随时同步">
                <img src="/images/964b896a.png" alt="云端备份 安全可靠">
                <img src="/images/72297351.png" alt="为中国用户贴心设计">
            </div>
        </div>
    </div>
    <div class="ft">
    ...
    <script src="/javascripts/5c4da2bd.js"></script>
