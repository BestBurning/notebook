...
<link type="text/css" rel="stylesheet"
	href="/styles/7ac21bf4.css">
<script src="/javascripts/rlog.js" async=""
	type="text/javascript"></script>
<script src="/javascripts/67b4ad50.js"></script>
</head>
<body>
							...
							<div class="download-bar-sub">
								<div class="btn-normal">
									<div class="download-qrcode">
										<img src="/images/84f03692.png" alt="二维码下载">
									</div>
								</div>
								<div class="btn-normal">
									<a
		...
		<div id="bd" class="clearfix">
			<ul class="intros">
				<li><a class="btn-video-play cboxElement">
						<div>
							<img src="/images/a1a70e40.png" alt="一分钟快速认识云协作"><img
								src="/images/71fec3d9.png" alt="play"
				...
				<li class="intro-platform">
					 <a					>
						<div>
							<img src="/images/20f4ba23.png" alt="云协作企业版"><span
				...
				<li>
					<div>
						<img src="/images/02e7cce7.png" alt="AppStore精选效率APP">
					</div> 
				</li>
			</ul>
		</div>
		<div id="footer">
			<ul id="ft-follow-us">
				<li><a href="http://weibo.com/youdaonote" id="weibo"
					target="_blank"></a></li>
				<li><a id="wechat"><img
						src="/images/e5ea2639.png"></a></li>
				<li><a id="qq"><img src="/images/d984692a.png"></a></li>
			</ul>
			<ul id="ft-links">
				<li><a
